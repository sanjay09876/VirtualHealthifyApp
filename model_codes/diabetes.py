...
df = pd.read_csv(r"/Users/sanjaykumar/Downloads/Health-App-main/data/diabetes.csv")
...
joblib.dump(model,r"/Users/sanjaykumar/Downloads/Health-App-main/Diabetes_API/diabetes_model.pkl")
